...
25. Legal & ethical checklist:

- **Never transmit** to an object you don’t own or are not explicitly authorized to contact. Even if treaties change, coordinate with recognized bodies and operators before uplinks.
- If you detect a live transmission from a satellite that appears abandoned and potentially hazardous or of interest, report to: SatNOGS, AMSAT, Space-Track (if you have institutional contacts), or national space authority.
...
## Important legal/ethics doc

`docs/legal_ethics.md` — include: **do not transmit** to satellites without authorization, report findings to SatNOGS/AMSAT/authorities, cite local rules. (Keep uplinks out of this pipeline.)
