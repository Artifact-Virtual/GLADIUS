---
title: Development Build Plan
description: Project build plan, goals, and development roadmap for Herald trading system
tags: [development, build-plan, roadmap, goals]
slug: /docs/development/build-plan
---
...
Phase 1 provides a **hardened foundation** for autonomous trading development.
...
- ✅ NO stubs, placeholders, or TODOs in release code
...
Phase 2 provides **deployment-tested autonomous trading** with complete entry and exit execution.

Phase 3 — Advanced Technical Analysis (MQL5 Indicators Coverage)
OBJECTIVE: Implement comprehensive technical analysis covering ALL MQL5 indicator methodologies.

**Price Action Analysis** (MQL5 Articles: Price Action Series)
- [ ] Candlestick Pattern Recognition Engine
  - Japanese candlestick patterns (Doji, Engulfing, Hammer, Shooting Star, etc.)
  - Multi-candle patterns (Morning/Evening Star, Three White Soldiers, etc.)
  - Pattern strength scoring and confirmation logic
- [ ] Support/Resistance Zone Detection
  - Pivot point calculation (Standard, Fibonacci, Woodie, Camarilla)
  - Dynamic S/R from price action clusters
  - Zone strength and touch count tracking
- [ ] Pattern Density Heatmap
  - Visual pattern frequency analysis
  - Zone-based pattern clustering
...
**Advanced Chart Types** (MQL5 Articles: Chart Analysis)
- [ ] Kagi Chart Implementation
  - Reversal amount calculation
  - Trend identification from Kagi
  - Integration with standard OHLCV data
- [ ] Renko Chart Generator
  - Brick size optimization
  - Trend clarity analysis
- [ ] Point and Figure Charts
  - Box size and reversal calculation
  - Pattern recognition (Double Top/Bottom, etc.)

**Volume Analysis** (MQL5 Articles: Volume Profile)
- [ ] Volume Profile Indicator (VPVR)
  - Point of Control (POC) calculation
  - Value Area High/Low (VAH/VAL)
  - Volume nodes and gaps
- [ ] Adaptive Volume Profile Trading (AVPT)
...
**Statistical Analysis** (MQL5 Articles: Statistics and Analysis)
...
**Session-Based Trading** (MQL5 Articles: Trading Systems)
- [ ] Opening Range Breakout (ORB)
  - Session open/close detection
  - Range calculation and breakout levels
  - Multi-session support (London, NY, Tokyo, Sydney)
- [ ] Session Volume Profiles
  - Per-session volume analysis
  - Session overlap detection
  - Time-of-day patterns

**Advanced Indicators** (MQL5 Documentation: Technical Indicators)
- [ ] Ichimoku Cloud Complete
  - All 5 lines (Tenkan, Kijun, Senkou A/B, Chikou)
  - Cloud signals and crossovers
  - Multi-timeframe Ichimoku
- [ ] Market Profile
  - TPO (Time Price Opportunity) charts
  - Initial balance range
  - Single print detection
- [ ] Momentum Indicators Extended
  - Williams %R
  - Commodity Channel Index (CCI)
  - Rate of Change (ROC)
  - Ultimate Oscillator

Phase 4 — Machine Learning Integration (MQL5 ML Coverage)
OBJECTIVE: Implement ML pipeline covering ALL MQL5 machine learning articles and the official ML book.

**Feature Engineering** (MQL5 Articles: Machine Learning)
...
- [ ] Time-Based Features
  - Hour/day/session encoding
  - Cyclical feature encoding
  - Calendar anomalies (day-of-week effects)
...
**Supervised Learning Models** (MQL5 Book: Neural Networks for Algorithmic Trading)
- [ ] Classical ML Models
...
**Deep Learning Architectures** (MQL5 Articles: Neural Networks Series)
...
- [ ] Transformer Architecture (MQL5 Articles: Transformers)
  - Self-attention mechanism
  - Positional encoding
  - Multi-head attention
  - Transformer encoder for trading
- [ ] ResNeXt Architecture (MQL5 Articles: ResNeXt)
  - Residual connections
  - Cardinality concept
  - Group convolutions

**ONNX Integration** (MQL5 Documentation: ONNX Models)
- [ ] ONNX Model Loading
  - Model format understanding
  - Runtime initialization
  - Input/output tensor handling
- [ ] Python-to-MQL5 Pipeline
  - Train in Python (PyTorch/TensorFlow)
  - Export to ONNX format
  - Load and inference in Herald
- [ ] Model Versioning
  - Model registry
...
Phase 5 — Reinforcement Learning & Advanced AI (MQL5 RL Coverage)
OBJECTIVE: Implement RL-based trading systems from MQL5 articles.

**Reinforcement Learning Foundation** (MQL5 Articles: DQN, PPO Series)
- [ ] Environment Design
  - Trading environment (Gym-style interface)
  - State space definition (market features)
  - Action space (buy, sell, hold, position sizing)
  - Reward function design (Sharpe, P&L, risk-adjusted)
- [ ] Deep Q-Network (DQN)
...
**Strategy Selection & Meta-Learning** (MQL5 Articles: AI-Powered Trading)
...
- [ ] Adaptive Parameter Optimization
  - Online learning for parameters
  - Contextual bandits for parameter selection
  - Meta-optimization

**Sentiment & Alternative Data** (MQL5 Articles: Integration)
...
Phase 6 — Integration & Infrastructure (MQL5 Docs Coverage)
OBJECTIVE: Implement ALL MQL5 integration capabilities and infrastructure.

**API & Network Integration** (MQL5 Articles: WebRequest, API Mastery)
- [ ] WebRequest Mastery
  - HTTP/HTTPS requests
  - REST API consumption
  - JSON/XML parsing
  - Authentication handling (API keys, OAuth)
- [ ] Socket Communication (MQL5 Articles: Sockets)
...
- [ ] External Service Integration
  ...
  - Data provider APIs
  - Notification services (Telegram, Discord, Slack)

**Database Operations** (MQL5 Documentation: Databases)
- [ ] SQLite Advanced
  - Complex queries
...
**Python Integration** (MQL5 Documentation: Python Integration)
- [ ] Python Bridge
  - MT5 Python library
...
**OpenCL Acceleration** (MQL5 Documentation: OpenCL)
- [ ] GPU Computation
...
**Multi-Asset & Multi-Currency** (MQL5 Articles: Multi-Currency EAs)
...
- [ ] Basket Trading
  ...
  - Sector rotation
  - Hedging strategies
- [ ] Custom Symbols (MQL5 Documentation: Custom Symbols)
  - Synthetic instrument creation
  - Spread instruments
  - Index calculation

Phase 7 — Risk Management & Options (MQL5 Advanced Risk)
OBJECTIVE: Advanced risk management including options concepts.

**Advanced Risk Management** (MQL5 Articles: Risk Management GUIs)
- [ ] Risk Dashboard
...
**Options Concepts** (MQL5 Articles: Black-Scholes Greeks)
- [ ] Greeks Calculation
  - Delta, Gamma, Theta, Vega, Rho
  - Implied volatility extraction
  - Volatility surface modeling
- [ ] Options-Inspired Strategies
  - Gamma scalping concepts
  - Volatility trading
  - Delta-neutral strategies

**Market Simulation** (MQL5 Articles: Market Simulation)
- [ ] Synthetic Market Generation
  - Price path simulation (GBM, Jump Diffusion)
...
Phase 8 — Production & Testing (MQL5 Tester Coverage)
OBJECTIVE: Production-grade testing and deployment.

**Strategy Tester Integration** (MQL5 Documentation: Tester)
...
- [ ] Genetic Optimization
  ...
  - Population and mutation settings

**Performance Analytics** (MQL5 Articles: Statistics and Analysis)
- [ ] Trade Statistics
...
Phase 9 — Expert Advisor Patterns (MQL5 Examples)
OBJECTIVE: Implement patterns from MQL5 EA examples.

**EA Architecture Patterns** (MQL5 Documentation: Expert Advisors)
- [ ] MVC Paradigm (MQL5 Articles: MVC)
  - Model: data and logic
  - View: display and alerts
  - Controller: user interaction
- [ ] Event-Driven Architecture
  - OnTick, OnBar, OnTimer patterns
...
**Services & Scripts** (MQL5 Documentation: Services, Scripts)
- [ ] Background Services
...
**Libraries & Includes** (MQL5 Documentation: Libraries, Include Files)
- [ ] Reusable Components
...
Phase 10 — GUI & Visualization (MQL5 UI Coverage)
OBJECTIVE: Implement professional trading interfaces.

**Trading GUI** (MQL5 Articles: Risk Management GUIs)
- [ ] Control Panel
  - Position overview
  - Quick trade buttons
...
**DirectX Integration** (MQL5 Documentation: DirectX)
- [ ] 3D Visualization
  - Volatility surface 3D
  - Correlation matrix 3D
...
Add more strategies beyond SMA Crossover
Tune mindset parameters based on backtesting
