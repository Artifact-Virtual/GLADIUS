...
Exodus ARC is an cthulu-native strategy service that implements a classic trend-following
workflow using the Donchian Channel breakouts, ATR-based sizing,
and pyramiding. Exodus ARC is designed to run inside cthulu but can also interoperate with
