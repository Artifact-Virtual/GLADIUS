...
class Mesh:
    def __init__(self, adapter):
        self.adapter = adapter
        self.planner = Planner("planner", adapter, "You decompose tasks into executable steps.")
        self.executor = Executor("executor", adapter, "You execute plans strictly using tools.")
